...
import { AddnewdiscountsComponent } from './manage-discounts/addnewdiscounts/addnewdiscounts.component';
...
const routes: Routes = [
  ...
  { path:'addnewdiscounts', component:AddnewdiscountsComponent}
];
